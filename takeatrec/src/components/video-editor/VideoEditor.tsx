...
export default function VideoEditor() {
	...
	const projectDisplayName = useMemo(() => {
		const fileName =
			...
			"";
		const withoutExtension = fileName.replace(/\.(recordly|takeatrec)$/i, "").replace(/\.[^.]+$/, "");
					...
					<DialogHeader>
						...
						<DialogDescription className="text-muted-foreground">
							{t(
								...
								"Name this project. It will be saved in your Takeat Rec Projects folder.",
							)}
						</DialogDescription>
					</DialogHeader>
					<div className="py-4">
				...
				<DialogHeader>
					...
					<DialogDescription className="text-muted-foreground">
						{t(
							...
							"Your device does not support native capture. This could be for a variety of reasons we haven’t figured out yet. This doesn’t break Takeat Rec, but it does make cursor smoothing impossible.",
						)}
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
	...
	return (
		<div className="flex flex-col h-screen bg-editor-bg text-foreground overflow-hidden selection:bg-[#e11d2e]/30">
			<div
			...
			>
				...
				>
					<Button
						...
						variant="ghost"
						size="sm"
						onClick={() => window.electronAPI?.backToRecording?.()}
						className={APP_HEADER_ICON_BUTTON_CLASS}
						title={t("editor.project.backToRecording", "Back to recording options")}
						aria-label={t("editor.project.backToRecording", "Back to recording options")}
					>
						<ArrowLeft className="h-4 w-4" />
					</Button>
					<div className="ml-0.5 mr-0.5 h-5 w-px bg-foreground/10" />
					<Button
				...
				>
					{isEditingProjectName ? (
						...
						>
							{hasUnsavedChanges ? (
								<span className="mt-[1px] size-2 shrink-0 rounded-full bg-[#e11d2e]" />
							) : null}
							<input
								...
								>
									...
									<div className="flex items-center gap-2">
										...
										<Button
											type="submit"
											size="sm"
											className="h-9 rounded-xl bg-[#e11d2e] px-3 text-white hover:bg-[#c81627]"
										>
											{t("common.actions.save", "Save")}
										</Button>
									</div>
												...
												return (
													<div
														...
														className={cn(
															...
															isActive
																? "border-[#e11d2e]/20 bg-[#e11d2e]/10 text-foreground"
													...
													>
														...
														>
															...
															{isActive ? (
																<Check className="h-3.5 w-3.5 shrink-0 text-[#e11d2e]" />
															) : null}
														</button>
														<button
															type="button"
					...
					>
						<DropdownMenuTrigger asChild>
							<Button
								...
								className="inline-flex h-8 min-w-[112px] items-center justify-center gap-2 rounded-[5px] bg-[#e11d2e] px-4.5 text-white transition-colors hover:bg-[#e11d2e]/92"
							>
								...
								<div className="rounded-2xl border border-foreground/10 bg-editor-surface p-4 text-foreground shadow-2xl">
									...
									<div className="h-2 overflow-hidden rounded-full border border-foreground/5 bg-foreground/5">
										...
										isExportFinalSaveIndeterminate ? (
											...
											<div
												className="h-full bg-[#e11d2e] transition-all duration-300 ease-out"
												style={{
									...
									<div className="mt-4 flex gap-2">
										{hasPendingExportSave ? (
											<Button
												...
												className="h-8 flex-1 rounded-[5px] bg-[#e11d2e] text-xs font-semibold text-white hover:bg-[#e11d2e]/92"
											>
										...
										<div className="ml-1.5 h-1.5 w-1.5 flex-shrink-0">
											{isActive && (
												<motion.span
													...
													className="block h-1.5 w-1.5 rounded-full bg-[#e11d2e]"
						...
						<div className="relative flex flex-shrink-0 items-center px-1 py-1">
							...
							<div className="z-10 flex min-w-0 flex-1 items-center gap-1.5">
								...
								<Button
									...
									variant="ghost"
									size="icon"
									className="h-7 w-7 rounded-full text-muted-foreground transition-all hover:bg-[#e11d2e]/10 hover:text-[#e11d2e]"
							...
							<div className="z-10 ml-auto flex items-center gap-2">
								<div className="flex items-center gap-1.5">
									...
									<div className="relative flex h-7 w-24 select-none items-center overflow-hidden rounded-full border border-foreground/[0.06] bg-editor-bg/80 shadow-[inset_0_1px_0_hsl(var(--foreground)/0.06)]">
										...
										/>
										<div
											className="pointer-events-none absolute bottom-[18%] top-[18%] z-10 w-[2px] rounded-full bg-foreground/95 shadow-[0_0_10px_rgba(225, 29, 46,0.28)]"
					...
					<div className="fixed left-1/2 top-1/2 z-[60] max-h-[90vh] w-[90vw] max-w-5xl -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-2xl border border-foreground/10 bg-editor-dialog p-8 shadow-2xl animate-in zoom-in-95 duration-200">
						...
						<div className="mt-6 flex justify-end">
							<Button
								...
								size="lg"
								className="bg-[#e11d2e] text-white hover:bg-[#e11d2e]/90"
							>
