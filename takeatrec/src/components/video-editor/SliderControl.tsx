...
export const SliderControl = memo(function SliderControl({
	...
	const dividerClass =
		accentColor === "purple"
			...
			: "bg-foreground/95 shadow-[0_0_10px_rgba(225, 29, 46,0.28)]";
	...
	return (
		<div
			...
			className="relative flex h-10 w-full select-none items-center overflow-hidden rounded-xl bg-editor-bg/80 px-1.5 outline-none focus-visible:ring-1 focus-visible:ring-[#e11d2e]/40"
			style={
				{
