									...
									>
										<div className="relative aspect-[16/10] w-full overflow-hidden rounded-[5px] bg-editor-dialog-alt shadow-[0_10px_18px_rgba(0,0,0,0.28)] transition duration-200 group-hover:-translate-y-0.5 group-hover:shadow-[0_16px_30px_rgba(0,0,0,0.38)]">
											{thumbnailSrc ? (
												...
												<div className="flex h-full w-full items-center justify-center bg-[linear-gradient(180deg,_rgba(225, 29, 46,0.22),_rgba(13,17,23,0.92))] text-[10px] font-medium text-white/60">
													No preview yet
												</div>
											)}
											{entry.isCurrent ? (
												<div className="absolute right-1.5 top-1.5">
													<span className="rounded-[5px] bg-[#e11d2e] px-1.5 py-0.5 text-[8px] font-semibold uppercase tracking-[0.14em] text-white shadow-[0_8px_20px_rgba(225, 29, 46,0.28)]">
														Current
													</span>
												</div>
											) : null}
