				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#e11d2e]/50 focus:ring-offset-2 focus:ring-offset-editor-dialog",
							isSelected
								? "bg-[#e11d2e]/10 border-[#e11d2e]/50 text-[#e11d2e] dark:text-white"
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#e11d2e]/20 text-[#e11d2e]" : "bg-foreground/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#e11d2e]" />
						)}
					</button>
				);
			})}
