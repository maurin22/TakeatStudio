					...
					return (
						...
						>
							...
							<Switch
								...
								className="data-[state=checked]:bg-[#e11d2e] scale-75"
							/>
						</div>
					);
				}
					...
					return (
						<button
							...
							className={cn(
								...
								isActive &&
									"border-[#e11d2e]/70 bg-[#e11d2e]/12 shadow-[inset_0_0_0_1px_rgba(225, 29, 46,0.15)]",
							)}
						>
							<div className="flex items-start gap-3">
								<div
									className={cn(
										...
										isActive &&
											"border-[#e11d2e]/30 bg-[#e11d2e]/10 text-[#75A6FF]",
									)}
								>
		...
		<div className="flex flex-col gap-2">
			<div className="flex items-center justify-between">
				...
				<button
					...
					className="text-[10px] text-[#e11d2e] transition-opacity hover:opacity-80"
					title={
						showAdvanced
							? tSettings(
					...
					return (
						<ToggleGroupItem
							...
							className={cn(
								...
								"data-[state=on]:border-[#e11d2e]/70 data-[state=on]:bg-[#e11d2e]/12 data-[state=on]:text-foreground",
							)}
						>
...
export function SettingsPanel({
	...
	const wallpaperTileClass = (isSelected: boolean) =>
		cn(
			...
			isSelected
				? "border-[#e11d2e] bg-foreground/[0.08]"
								...
								>
									{isActive ? (
										<motion.span
											...
											className="absolute inset-0 rounded-lg bg-[#e11d2e]"
											transition={{
												type: "spring",
												stiffness: 420,
												damping: 34,
							...
							{backgroundTab === "image" ? (
								<div className="mt-0 space-y-2">
									...
									<Button
										...
										variant="outline"
										className="w-full gap-2 bg-foreground/5 text-foreground border-foreground/10 hover:bg-[#e11d2e] hover:text-white hover:border-[#e11d2e] transition-all h-7 text-[10px]"
									>
						...
						<div className="flex items-center justify-between">
							...
							{frame && (
								<button
									...
									className="text-[9px] text-[#e11d2e] hover:opacity-80"
								>
									Remove
								</button>
							)}
								...
								return (
									<button
										...
										className={cn(
											...
											isSelected
												? "border-[#e11d2e]/50 bg-[#e11d2e]/10 ring-1 ring-[#e11d2e]/30"
			...
			<div className="rounded-lg bg-foreground/[0.03] px-2.5 py-2 space-y-3">
					...
					<div className="grid w-full grid-cols-2 gap-2">
						{whisperModelDownloadStatus === "downloading" ? (
							...
							<Button
								...
								className="h-10 w-full rounded-xl bg-[#e11d2e] px-4 text-sm font-medium text-white hover:bg-[#e11d2e]/90"
							>
				...
				<div className="flex flex-col gap-2">
					<Button
						...
						className="h-10 w-full rounded-xl bg-[#e11d2e] px-4 text-sm font-medium text-white hover:bg-[#e11d2e]/90 disabled:opacity-60"
					>
		...
		const settingsSectionContent = (
			<div className="space-y-4">
				...
				{showDevMotionControls ? (
					<section className="flex flex-col gap-2 rounded-xl border border-[#e11d2e]/15 bg-[#e11d2e]/5 p-3">
						<div className="flex items-center justify-between gap-3">
							<div>
								<SectionLabel>
							...
							<span className="rounded-full bg-[#e11d2e]/10 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider text-[#e11d2e]">
								DEV
							</span>
						</div>
						...
						<div className="rounded-lg border border-foreground/10 bg-background/60 px-3 py-3">
							<div className="flex items-start justify-between gap-3">
								...
								<Button
									...
									className="h-8 shrink-0 border-[#e11d2e]/20 bg-[#e11d2e]/10 text-[#e11d2e] hover:bg-[#e11d2e]/15"
								>
												...
												return (
													<button
														...
														className={cn(
															...
															isSelected
																? "border-foreground/80 ring-1 ring-[#e11d2e]/50"
