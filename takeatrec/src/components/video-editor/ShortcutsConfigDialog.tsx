			...
			<DialogContent className="bg-editor-dialog border-foreground/10 text-foreground max-w-[460px]">
				<DialogHeader>
					<DialogTitle className="flex items-center gap-2 text-sm">
						<Keyboard className="w-4 h-4 text-[#e11d2e]" />
								...
								<div className="flex items-center justify-between py-1.5 px-1 border-b border-foreground/5">
									...
									<button
										...
										className={[
											...
											isCapturing
												? "bg-[#e11d2e]/20 border-[#e11d2e] text-[#e11d2e] animate-pulse"
												: hasConflict
													? "bg-amber-500/10 border-amber-500/50 text-amber-400"
													: "bg-foreground/5 border-foreground/10 text-foreground hover:border-[#e11d2e]/50 hover:text-[#e11d2e] cursor-pointer",
										].join(" ")}
									>
										{isCapturing
				...
				<DialogFooter className="flex gap-2 sm:justify-between mt-2">
					...
					<div className="flex gap-2">
						...
						<Button
							size="sm"
							className="bg-[#e11d2e] hover:bg-[#c81627] text-white"
							onClick={handleSave}
						>
