...
export default function PlaybackCursor({
	...
	return (
		...
		>
			<div
				className="absolute top-0 bottom-0 w-[2px] bg-[#e11d2e] shadow-[0_0_10px_rgba(225, 29, 46,0.5)] cursor-ew-resize pointer-events-auto hover:shadow-[0_0_15px_rgba(225, 29, 46,0.7)] transition-shadow"
			...
			>
				...
				>
					<div className="w-3 h-3 mx-auto mt-[2px] bg-[#e11d2e] rotate-45 rounded-sm shadow-lg border border-foreground/20" />
				</div>
				<div
					className={cn(
