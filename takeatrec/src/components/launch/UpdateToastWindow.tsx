...
export function UpdateToastWindow() {
	...
	const iconBoxStyle = {
		...
		color: "#f87171",
		boxShadow: "inset 0 0 0 1px rgba(225, 29, 46, 0.18)",
	} as const;
	const titleStyle = {
		fontSize: 15,
		fontWeight: 700,
	...
	const primaryButtonStyle = {
		...subtleButtonStyle,
		border: "none",
		background: "linear-gradient(180deg, #ef4444 0%, #e11d2e 100%)",
		color: "#ffffff",
		boxShadow: "0 12px 24px rgba(225, 29, 46, 0.26)",
	} as const;
	const selectStyle = {
		height: 38,
		borderRadius: 12,
		...
		fontWeight: 600,
		outline: "none",
		boxShadow: "inset 0 0 0 1px rgba(225, 29, 46, 0.06)",
		cursor: "pointer",
	} as const;
							...
							>
								<div
									style={{
										...
										borderRadius: 999,
										background:
											"linear-gradient(90deg, #f87171 0%, #e11d2e 45%, #c81627 100%)",
										boxShadow: "0 0 22px rgba(225, 29, 46, 0.38)",
									}}
								/>
							</div>
							<div
